...
class StudentService:
    ...
    def _student_to_dict(self, student: Student, db: Session) -> Dict[str, Any]:
        ...
        return {
            ...
            'meeting_status': student.meeting_status.value if student.meeting_status else "UNKNOWN",
            'call_status': student.call_status.value if student.call_status else "UNKNOWN",
            'decision_status': student.decision_status.value if student.decision_status else "UNKNOWN",
